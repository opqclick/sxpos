                            ...
                            <div class="col-lg-3 col-6">
                                <div class="card" style="min-height: 225px;">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-3"></h6>
                                        <h3 class="mb-0">{{ $monthlySelledAmount }}<span class="text-success text-sm"><i
                                                    class=""></i> </span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="card" style="min-height: 225px;">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-3"></h6>
                                        <h3 class="mb-0">{{ $totalSelledAmount }}<span class="text-danger text-sm"><i
                                                    class=""></i></span></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="card" style="min-height: 225px;">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-3"></h6>
                                        <h3 class="mb-0">{{ $totalPurchasedAmount }}<span class="text-danger text-sm"><i
                                                    class=""></i> </span></h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                @if (isset($todos) && !empty($todos) && count($todos) > 0)
                                    <ul class="list-group list-group-flush todo-scrollbar" data-toggle="checklist">
                                        @foreach ($todos as $key => $todo)
                                            <li
                                                class="checklist-entry list-group-item flex-column align-items-start bg-{{ $todo->color }}">
                                                <div
                                                    ...
                                                    <div class="checklist-info">
                                                        <a href="#!"
                                                            class="fs-14 mb-0"><b>{{ $todo->title }}</b></a>
                                                        <small
