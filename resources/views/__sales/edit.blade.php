                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $('<tr id=' + data[i].product_id + '>')
                                .append(
                                    ...
                                    .product_id + '">' +
                                    '<input type="text" step="1" min="1" style="width: 50px" name="quantity[]" title="{{ __('Quantity') }}" class="input-number" size="4" data-id="' +
                        ...
                        if ($.inArray(ui.item.id, items) == -1) {
                            ...
                            $('<tr id=' + ui.item.id + '>')
                                .append(
                                    ...
                                    '<input type="text" step="1" min="1" max="' + ui.item.maxquantity +
