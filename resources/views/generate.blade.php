...
<form action="" id="myForm">
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">    
                ...
                <select name="language" class="form-select form-control" id="language">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <select name="ai_creativity" id="ai_creativity" class="form-select form-control">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <select name="num_of_result" id="" class="form-select form-control">
                    @for($i = 1; $i <= 10; $i++)
    ...
    <div class="response" >
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary btn-sm float-left mb-1 ms-1" href="#!" id="generate">{{ __('Generate') }}</a>
                <a href="#!" onclick="copyText()" class="btn btn-primary btn-sm float-end mb-1"><i class="ti ti-copy"></i>{{ __('Copy Text') }}</a>
