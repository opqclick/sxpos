...
@section('title')
    <div class="d-inline-block">
        <h4 class="title">{{ __('Service Wise Sale Report') }}</h4>
    </div>
@endsection
...
<li class="breadcrumb-item">{{ __('Service Wise Sale Report') }}</li>
@endsection
        ...
        <div class="col-lg-3 col-6">
            <div class="card" style="min-height: 225px;">
                <div class="card-body">
                    ...
                    <h6 class="mb-3"></h6>
                    <h3 class="mb-0">{{ $number_of_payments }}<span class="text-success text-sm"><i class=""></i> </span></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="card" style="min-height: 225px;">
                <div class="card-body">
                    ...
                    <h6 class="mb-3"></h6>
                    <h3 class="mb-0">${{ $total_amount_of_payments }}<span class="text-success text-sm"><i class=""></i> </span></h3>
                </div>
            </div>
        </div>
    </div>
