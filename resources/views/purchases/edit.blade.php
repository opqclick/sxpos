...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Edit Purchase') }}</h5>
    </div>
@endsection
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $('<tr id=' + data[i].product_id + '>')
                                .append(
                                    ...
                                    .product_id + '">' +
                                    '<input type="number" step="1" min="1" style="width: 50px" name="quantity[]" title="{{ __('Quantity') }}" class="quantity input-number" size="4" data-id="' +
                        ...
                        if ($.inArray(ui.item.id, items) == -1) {
                            ...
                            $('<tr id=' + ui.item.id + '>')
                                .append(
                                    ...
                                    '" name="quantity[]" title="{{ __('Quantity') }}" class="quantity input-number" size="4" data-id="' +
