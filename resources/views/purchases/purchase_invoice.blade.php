...
<div class="m-6">
    ...
    <div class="container position-relative">
        <div class="download_btn">
            <a onclick="saveAsPDF()" class="btn btn-sm btn-primary btn-icon-only ml-2 shadow-sm">
        ...
        <div class="row invoice" id="printableArea">
            <div class="col-12 card p-4">
                <div class="invoice-details">
                    <h1 class="invoice-id h4 text-end">{{ $details['invoice_id'] }}</h1>
                    <div class="date mb-3 text-end">{{ __('Date of Invoice') }}: {{ $details['date'] }}</div>
                <div class="date mb-3 float-end mt-3">{!! DNS2D::getBarcodeHTML(route('purchase.link.copy',\Illuminate\Support\Facades\Crypt::encrypt($purchase->id)),'QRCODE',2,2) !!}</div>
