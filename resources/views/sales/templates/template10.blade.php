            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <p>
                                <b style="color: {{($color == '#ffffff') ? 'black' : $color}};"> FROM:</b><br>
                        ...
                        <td>
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td style="color: {{($color == '#ffffff') ? 'black' : $color}};"><b>Number:</b> </td>
                                        <td class="text-right">
                                            {{$user->sellInvoiceNumberFormat($sale->invoice_id)}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: {{($color == '#ffffff') ? 'black' : $color}};"><b>Issue Date:</b></td>
                                        <td class="text-right">
                                            {{$user->dateFormat($sale->created_at)}}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
