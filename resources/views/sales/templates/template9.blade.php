        ...
        <div class="invoice-header">
            <table>
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: {{($color == '#ffffff') ? 'black' : $color}}; margin-bottom: 10px;">SALE</h3>
                            <table class="no-space" style="width: 70%;">
                                <tbody>
                                    <tr>
                                        <td>Number: </td>
                                        <td class="text-right">{{$user->sellInvoiceNumberFormat($sale->invoice_id)}}</td>
                                    </tr>
                                    <tr>
                                        <td>Issue Date:</td>
                                        <td class="text-right">{{$user->dateFormat($sale->created_at)}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="view-qrcode" style="margin-top: 0;">
                                                {!! DNS2D::getBarcodeHTML(route('sale.link.copy',\Illuminate\Support\Facades\Crypt::encrypt($sale->id)),'QRCODE',2,2) !!}
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td><b>{{ __('Total') }} :</b></td>
                                    <td style="width: 95px;"><b>{{ $sale->subtotal }}</b>
