            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="#" class="btn btn-primary btn-sm float-end" data-size="md" data-ajax-popup-over="true" data-url="{{ route('generate',['quotations']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Quotation Detail') }}">
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $('<tr id=' + data[i].product_id + '>')
                                .append(
                                    ...
                                    '<input type="number" step="1" style="width: 50px" min="1" max="' + data[i].maxquantity + '" name="quantity[]" title="{{ __('Quantity') }}" class="quantity input-number" size="4" data-id="' + data[i].product_id + '" data-price="' + data[i].price + '" data-tax="' + data[i].tax + '" value="' + data[i].quantity + '">' +
                    ...
                    if ($.inArray(ui.item.id, items) == -1) {
                        ...
                        $('<tr id=' + ui.item.id + '>')
                            .append(
                                ...
                                '<input type="number" step="1" min="1" max="' + ui.item.maxquantity + '" name="quantity[]" title="{{ __('Quantity') }}" class="quantity input-number" size="4" data-id="' + ui.item.id + '" data-price="' + ui.item.price + '" data-tax="' + ui.item.tax + '" value="' + ui.item.quantity + '">' +
                                '<input type="button" value="+" class="plus"></div></td>' +
                                '<td>' + ui.item.tax + '%</td>' +
