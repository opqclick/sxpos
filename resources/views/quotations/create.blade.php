                    ...
                    if ($.inArray(ui.item.id, items) == -1) {
                        ...
                        $('<tr id=' + ui.item.id + '>')
                            .append(
                                ...
                                '<input type="number" step="1" style="width: 50px" min="1" max="' + ui.item.maxquantity + '" name="quantity[]" title="{{ __('Quantity') }}" class="quantity input-number" size="4" data-id="' + ui.item.id + '" data-price="' + ui.item.price + '" data-tax="' + ui.item.tax + '" value="' + ui.item.quantity + '">' +
