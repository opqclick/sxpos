                        ...
                        <td>
                            ...
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{__('Number')}}:</td>
                                        <td>{{$user->quotationInvoiceNumberFormat($quotation->invoice_id)}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{__('Billing Date')}}:</td>
                                        <td>{{$user->dateFormat($quotation->created_at)}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{__('Billing Time')}}:</td>
                                        <td>{{$user->timeFormat($quotation->created_at)}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{__('Status')}}:</td>
                                        <td>{{ ($quotation->status == 1) ? __('Partially Paid') : (($quotation->status == 2) ? __('Paid') : __('Unpaid')) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
