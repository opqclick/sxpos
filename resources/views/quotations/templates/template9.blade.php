        ...
        <div class="invoice-header">
            <table>
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: {{($color == '#ffffff') ? 'black' : $color}}; margin-bottom: 10px;">QUOTATION</h3>
                            <table class="no-space" style="width: 70%;">
                                <tbody>
                                    <tr>
                                        <td>Number: </td>
                                        <td class="text-right">{{$user->quotationInvoiceNumberFormat($quotation->invoice_id)}}</td>
                                    </tr>
                                    <tr>
                                        <td>Issue Date:</td>
                                        <td class="text-right">{{$user->dateFormat($quotation->created_at)}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
