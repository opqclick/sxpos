...
class BranchSalesTargetController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(Auth::user()->can('Create Branch Sales Target'))
        {
            ...
            return redirect()->route('branchsalestargets.index')->with('success', $bst->month . ' ' . __('Target created successfully.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function update(Request $request, BranchSalesTarget $branchsalestarget)
    {
        if(Auth::user()->can('Edit Branch Sales Target'))
        {
            ...
            return redirect()->route('branchsalestargets.index')->with('success', $branchsalestarget->month . ' ' . __('Target updated successfully.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
