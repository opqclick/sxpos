...
$(document).on('click', 'a[data-ajax-popup="truee"], button[data-ajax-popup="truee"]', function(e) {
    e.preventDefault();
    ...
    $("#commonModal1 .modal-title").html(title);
    $("#commonModal1 .modal-dialog").addClass('modal-' + size + ' modal-dialog-' + align);
