...
Route::get('/clear-cache', function () {
    ...
    return redirect()->back()->with('success', __('Cache cleared successfuly.'));
...
Route::get('service-sale-history/{id}/{customer_id}/{type}', [ProductController::class,'serviceHistoryDetails'])->middleware(['XSS']);
...
//barcode
Route::get('setting/product', [ProductController::class, 'setting'])->name('product.setting')->middleware(['auth', 'XSS']);
Route::post('barcode/settings', [ProductController::class, 'BarcodesettingStore'])->name('barcode.setting');
Route::any('product-receipt', [ProductController::class, 'receipt'])->name('product.receipt')->middleware(['auth', 'XSS']);
Route::get('print/product', [ProductController::class, 'printBarcode'])->name('product.print')->middleware(['auth', 'XSS']);
...
Route::get('purchased-invoices/preview/{template}/{color}', [PurchaseController::class,'previewPurchasedInvoice'])->name('purchased.invoice.preview')->middleware(['auth','XSS']);
...
//sale payment print
Route::get('print/sale', [SaleController::class, 'print'])->name('sale.print')->middleware(['auth', 'XSS']);
//Route::get('sale_receipt', [SaleController::class, 'receipt'])->name('sale.receipt')->middleware(['auth', 'XSS']);


Route::get('selled-invoice/{id}', [SaleController::class,'selledInvoice'])->name('selled.invoice');
Route::get('selled-invoices/preview/{template}/{color}', [SaleController::class,'previewSelledInvoice'])->name('selled.invoice.preview')->middleware(['auth','XSS']);
...
Route::any('calendars/get_event_data', [CalendarController::class, 'get_event_data'])->name('event.get_event_data')->middleware(['auth', 'XSS']);
...
// create customer show any error so remove following both Route
...
Route::get('{id}/plan-get-payment-status/{amount}', [PaypalController::class,'planGetPaymentStatus'])->name('plan.get.payment.status')->middleware(['auth', 'XSS']);
...
Route::get('export/stockanalysis', [ReportController::class,'stockanalysisexport'])->name('stockanalysis.export');
Route::get('export/categoryreport', [ReportController::class,'categoryreportexport'])->name('categoryreport.export');
Route::get('export/brandreport', [ReportController::class,'brandreportexport'])->name('brandreport.export');
Route::get('export/purchasetaxreport', [ReportController::class,'purchasesexport'])->name('purchases.export');
Route::get('export/saletaxreport', [ReportController::class,'salesexport'])->name('sales.export');
Route::get('export/expensereport', [ReportController::class,'expensereportexport'])->name('expensereport.export');
Route::get('export/customerreport', [ReportController::class,'customerreportexport'])->name('customerreport.export');
Route::get('export/vendorreport', [ReportController::class,'vendorreportexport'])->name('vendorreport.export');
...
Route::post('import/vender', [VendorController::class,'import'])->name('vendors.import');
