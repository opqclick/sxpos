                                                ...
                                                <?php if($customer->is_active == 1): ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Customer')): ?>
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="<?php echo e(route('customers.edit', $customer->id)); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                                title="<?php echo e(__('Edit Customer')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/AsynchronousDigital/POSGo/resources/views/customers/index.blade.php ENDPATH**/ ?>