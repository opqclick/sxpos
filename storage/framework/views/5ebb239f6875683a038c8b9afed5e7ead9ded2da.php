            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold;">QUOTATION</h3>
                        </td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>Number: </td>
                                        <td class="text-right">
                                            <?php echo e($user->quotationInvoiceNumberFormat($quotation->invoice_id)); ?>
                                    ...
                                    <tr>
                                        <td>Issue Date:</td>
                                        <td class="text-right">
                                            <?php echo e($user->dateFormat($quotation->created_at)); ?>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="view-qrcode">
                                                <?php echo DNS2D::getBarcodeHTML(route('get.quotation.invoice',\Illuminate\Support\Facades\Crypt::encrypt($quotation->id)),'QRCODE',2,2); ?>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 95px;"><b><?php echo e($quotation->subtotal); ?></b>
...
<?php /**PATH /var/www/html/AsynchronousDigital/POSGo/resources/views/quotations/templates/template1.blade.php ENDPATH**/ ?>