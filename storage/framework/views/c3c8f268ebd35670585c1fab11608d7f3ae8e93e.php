...
<?php
    ...
    $purchase_id = Auth::user()->purchaseInvoiceNumberFormat($purchase->invoice_id);
                                            ...
                                            <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Subject : ').'Products Purchase ('.$purchase_id.').'); ?></b></p>
                                                                <p style="line-height:32px"><b style="font-weight:700"><?php echo e(__('Hi ').$vendor_name.','); ?></b></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0;"><?php echo e(__('Hope this email ﬁnds you well! Please see attached invoice number')); ?> <?php echo e(' '. $purchase_id . ' '); ?> <?php echo e(__('for product purchase.')); ?></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                                <tr>
                                                                    <td align="center" bgcolor="#6676EF" role="presentation" style="border:none;border-radius:100px;cursor:auto;padding:15px 25px 15px 25px;background:#6676EF;" valign="middle">
                                                                        <a href="<?php echo e($purchase_url); ?>" style="background:#6676EF;color:#ffffff;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
                                                                            <b style="font-weight:700"><b style="font-weight:700"><?php echo e(__('Purchase')); ?></b></b>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
...
<?php /**PATH /var/www/html/AsynchronousDigital/POSGo/resources/views/emails/purchase_send.blade.php ENDPATH**/ ?>