            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold;">SALE</h3>
                        </td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>Number: </td>
                                        <td class="text-right">
                                            <?php echo e($user->sellInvoiceNumberFormat($sale->invoice_id)); ?>
                                    ...
                                    <tr>
                                        <td>Issue Date:</td>
                                        <td class="text-right">
                                            <?php echo e($user->dateFormat($sale->created_at)); ?>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="view-qrcode">
                                                <?php echo DNS2D::getBarcodeHTML(route('sale.link.copy',\Illuminate\Support\Facades\Crypt::encrypt($sale->id)),'QRCODE',2,2); ?>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 95px;"><b><?php echo e($sale->subtotal); ?></b>
...
<?php /**PATH /var/www/html/AsynchronousDigital/POSGo/resources/views/sales/templates/template1.blade.php ENDPATH**/ ?>