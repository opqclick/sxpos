...
?>
<!DOCTYPE html>
<html lang="en"  dir="<?php if(isset($setting['SITE_RTL'])): ?><?php echo e($setting['SITE_RTL'] == 'on'?'rtl':''); ?><?php else: ?><?php echo e(Utility::getValByName('SITE_RTL') == 'on' ? 'rtl' : ''); ?><?php endif; ?>">
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e($sup_logo.'/'. (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png').'?timestamp='.time()); ?>" type="image/x-icon" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav">
                        ...
                        <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($value->header == 'on' && $value->page_url != null): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url($value->page_url)); ?>" target="_blank"><?php echo e($value->menubar_page_name); ?></a>
                                </li>
                            <?php endif; ?>
                ...
                <div class="row g-0 gy-2 mt-4 align-items-center">
                    ...
                    <div class="col-xxl-9">
                        <div class="row gy-3 row-cols-9">
                            <div class="col-auto">
                                <img src="<?php echo e($logo.'/'. $settings['home_logo'] .'?timestamp='.time()); ?>" alt="" class="img-fluid"
                                    style="width: 130px;">
                            </div>
                            <div class="col-auto">
                                <img src="<?php echo e($logo.'/'. $settings['home_logo'] .'?timestamp='.time()); ?>" alt="" class="img-fluid"
