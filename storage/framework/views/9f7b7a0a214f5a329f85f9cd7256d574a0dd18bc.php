...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter new Account Name'), 'required'])); ?>
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('ref', null, ['class' => 'form-control', 'placeholder' => __('Enter new Account Reference'), 'required'])); ?>
