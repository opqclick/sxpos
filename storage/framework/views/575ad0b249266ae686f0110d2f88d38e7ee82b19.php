            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.toacart', function() {
                    ...
                    if(!customer_selected) {
                        show_toastr('<?php echo e(__('Info')); ?>', 'Please select customer first', 'info');
                        return false;
                    }
                    if($(this).attr('data-is-service') == 1) {
                        ...
                        let service_check_url = "<?php echo e(url('check-service-history')); ?>/"+$(this).attr('data-id')+"?customer_id="+customer_id;
