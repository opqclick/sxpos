                            ...
                            <div class="col-lg-3 col-6">
                                <div class="card" style="min-height: 225px;">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-3"></h6>
                                        <h3 class="mb-0"><?php echo e($monthlySelledAmount); ?><span class="text-success text-sm"><i
                                                    class=""></i> </span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-6">
                                <div class="card" style="min-height: 225px;">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-3"></h6>
                                        <h3 class="mb-0"><?php echo e($totalSelledAmount); ?><span class="text-danger text-sm"><i
                                                    class=""></i></span></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="card" style="min-height: 225px;">
                                    <div class="card-body">
                                        ...
                                        <h6 class="mb-3"></h6>
                                        <h3 class="mb-0"><?php echo e($totalPurchasedAmount); ?><span class="text-danger text-sm"><i
                                                    class=""></i> </span></h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <?php if(isset($todos) && !empty($todos) && count($todos) > 0): ?>
                                    <ul class="list-group list-group-flush todo-scrollbar" data-toggle="checklist">
                                        <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li
                                                class="checklist-entry list-group-item flex-column align-items-start bg-<?php echo e($todo->color); ?>">
                                                <div
                                                    ...
                                                    <div class="checklist-info">
                                                        <a href="#!"
                                                            class="fs-14 mb-0"><b><?php echo e($todo->title); ?></b></a>
                                                        <small
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/AsynchronousDigital/POSGo/resources/views/dashboard.blade.php ENDPATH**/ ?>