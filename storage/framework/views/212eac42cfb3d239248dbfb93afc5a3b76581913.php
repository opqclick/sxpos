...
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h4 class="title"><?php echo e(__('Service Wise Sale Report')); ?></h4>
    </div>
...
<li class="breadcrumb-item"><?php echo e(__('Service Wise Sale Report')); ?></li>
<?php $__env->stopSection(); ?>
        ...
        <div class="col-lg-3 col-6">
            <div class="card" style="min-height: 225px;">
                <div class="card-body">
                    ...
                    <p class="text-muted text-sm mt-4 mb-2">Number Of Payments</p>
                    <h6 class="mb-3"></h6>
                    <h3 class="mb-0"><?php echo e($number_of_payments); ?><span class="text-success text-sm"><i class=""></i> </span></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-6">
            <div class="card" style="min-height: 225px;">
                <div class="card-body">
                    ...
                    <p class="text-muted text-sm mt-4 mb-2">Total Amount Of Payments</p>
                    <h6 class="mb-3"></h6>
                    <h3 class="mb-0">$<?php echo e($total_amount_of_payments); ?><span class="text-success text-sm"><i class=""></i> </span></h3>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/AsynchronousDigital/POSGo/resources/views/reports/custom/service_wise_sale_report.blade.php ENDPATH**/ ?>